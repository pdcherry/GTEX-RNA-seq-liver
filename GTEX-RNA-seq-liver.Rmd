...
```{r, warning = FALSE}
TF_ranking <- rankTFs(DE_CM_chip_stats, rankMethod = "gsea", makePlot = TRUE)
#TF_ranking %>% arrange(wilc_pval) %>% slice_head(n = 40)
...
```{r}
TF_ranking$TF_ranking %>% arrange(pVal) %>% slice_head(n = 40)
```
